...
def load_quantized_model(
    ...
    try:
        from lib.utils.device_utils import mem_get_info
        _mem_info = mem_get_info(local_rank)
    except ImportError:
        _mem_info = torch.cuda.mem_get_info(local_rank)
    mmap = {local_rank: f"{_mem_info[1]*0.8/(1 << 30)}GiB"}
